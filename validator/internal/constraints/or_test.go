...
func TestOrConstraint_FirstMatches(t *testing.T) {
	...
	err := vl.Validate(&Form{Color: "#FF0000"})
...
func TestOrConstraint_SecondMatches(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Color: "rgb(255,0,0)"})
	require.NoError(t, err)
}
...
func TestOrConstraint_NoMatch(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Color: "invalid"})
	require.Error(t, err)
}
...
func TestOrConstraint_TripleOR_ThirdMatches(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Color: "rgba(255,0,0,0.5)"})
	require.NoError(t, err)
}
...
func TestOrConstraint_TripleOR_FirstMatches(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Color: "#ABC123"})
	require.NoError(t, err)
}
...
func TestOrConstraint_TripleOR_NoMatch(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Color: "not-a-color"})
	require.Error(t, err)
}
...
func TestOrConstraint_MixedTypes_EmailMatches(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Contact: "test@example.com"})
	require.NoError(t, err)
}
...
func TestOrConstraint_MixedTypes_URLMatches(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Contact: "https://example.com"})
	require.NoError(t, err)
}
...
func TestOrConstraint_MixedTypes_NoMatch(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Contact: "not-an-email-or-url"})
	require.Error(t, err)
}
...
func TestOrConstraint_NilPointer(t *testing.T) {
	...
	vl := validator.New[Form]()
	err := vl.Validate(&Form{Color: nil})
	require.NoError(t, err)
}
...
func TestOrConstraint_PointerToValidValue(t *testing.T) {
	...
	vl := validator.New[Form]()
	validColor := "#FF0000"
	err := vl.Validate(&Form{Color: &validColor})
	require.NoError(t, err)
}
...
func TestOrConstraint_PointerToInvalidValue(t *testing.T) {
	...
	err := vl.Validate(&Form{Color: &invalidColor})
	require.Error(t, err)
}
...
func TestOrConstraint_ComplexCombination(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := vl.Validate(&Form{Identifier: tt.value})
			if tt.wantErr {
				require.Error(t, err)
			} else {
				require.NoError(t, err)
...
func TestOrConstraint_AlphaOrNumeric(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := vl.Validate(&Form{Code: tt.value})
			if tt.wantErr {
				require.Error(t, err)
			} else {
				require.NoError(t, err)
