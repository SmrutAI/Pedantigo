...
// it reads the JSON body and runs pdcore.UnmarshalInto (which enforces required,
...
// pdcore.UnmarshalInto. For GET/DELETE/HEAD it delegates to Echo's DefaultBinder.
func (b *PedantigoBinder) Bind(i interface{}, c echo.Context) error {
	...
	if err := pdcore.UnmarshalInto(body, i); err != nil {
